...
@export var maximum_health: int = 140
@export var bullet_scene: PackedScene
@export var shoot_range: float = 770
@export var shoot_cooldown_seconds: float = 3
...
func _ready() -> void:
	...
	shoot_cooldown_remaining = initial_shoot_delay_seconds
	setup_health_bar()
